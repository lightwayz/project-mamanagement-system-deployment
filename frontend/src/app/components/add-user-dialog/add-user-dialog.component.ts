    ...
    <mat-dialog-content class="dialog-content">
      <form [formGroup]="userForm" class="user-form">
        ...
        <div class="password-section">
          ...
          <mat-radio-group formControlName="passwordOption" class="password-options">
            <mat-radio-button value="generate" class="password-radio">
              <div class="option-content">
                <div class="option-title">Generate Random Password</div>
                <div class="option-desc">System will create a secure password and email it to the user</div>
              </div>
            </mat-radio-button>
            
            <mat-radio-button value="custom" class="password-radio">
              <div class="option-content">
                <div class="option-title">Set Custom Password</div>
                <div class="option-desc">Manually specify the initial password</div>
              </div>
            </mat-radio-button>
          </mat-radio-group>

          <div *ngIf="userForm.get('passwordOption')?.value === 'custom'" class="custom-password-field">
            ...
            <div *ngIf="userForm.get('password')?.hasError('required') && userForm.get('password')?.touched" 
                 class="error-message">
              Password is required when using custom password option
            </div>
          ...
          <mat-checkbox formControlName="forcePasswordChange" class="force-change-checkbox">
...
export class AddUserDialogComponent {
  ...
  constructor(
    ...
    this.userForm = this.fb.group({
      ...
      passwordOption: ['generate', [Validators.required]],
      password: [''],
      forcePasswordChange: [true]
    });

    // Watch for password option changes
    this.userForm.get('passwordOption')?.valueChanges.subscribe(option => {
  ...
  onSave(): void {
    if (this.userForm.valid) {
      ...
      const userData: CreateUserRequest = {
        ...
        role: formValue.role,
        force_password_change: formValue.forcePasswordChange
      };

      if (formValue.passwordOption === 'custom') {
        userData.password = formValue.password;
        userData.generate_password = false;
      } else {
